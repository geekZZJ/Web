;(function (window, document) {
  ...
  Msg.prototype._createElement = function () {
    ...
    const footerHTML = this.footer
      ? '<div class="msg-footer">\
          <button class="msg-footer-btn msg-footer-cancel-button">' +
        cancelBtnName +
        '</button>\
          <button class="msg-footer-btn msg-footer-confirm-button">' +
        confirmBtnName +
        '</button>\
        </div>'
      : ''
  ...
  Msg.prototype._bind = function ({ el, overlay }) {
    ...
    if (this.footer) {
      el.querySelector(
        '.msg-footer .msg-footer-cancel-button'
      ).addEventListener('click', close)
      el.querySelector(
        '.msg-footer .msg-footer-confirm-button'
